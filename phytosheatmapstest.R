...
#### flora ####
{
  ...
  b4 <- flora_heatmap(fp_data = heatmap_data,  year = 2017, site = 50, z = "TotalConc_ugL", unitz = "ug/L")
  b5 <- flora_heatmap(fp_data = heatmap_data,  year = 2018, site = 50, z = "TotalConc_ugL", unitz = "ug/L")
